...
Pyramid::Pyramid(std::string name, glm::vec3 position, glm::vec3 objsize, GLfloat angel, glm::vec3 rotation, Texture texture): GameObject(name, position, objsize, angel, rotation, texture)
{
    float vertices[] = {
...
void Pyramid::drawObject(Rendering &render)
{
    glBindVertexArray(VAO);
